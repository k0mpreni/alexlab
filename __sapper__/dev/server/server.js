...
const Readings = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<ul class="svelte-9zhe3a">
	  ${each(books, ({ title, author, media, finished }) => `<li class="${[`svelte-9zhe3a`, finished ? "finished" : ""].join(' ').trim() }">
	      <h2 class="svelte-9zhe3a">${escape(title)}</h2>
	      <p>
	        <i>From: ${escape(author)}</i>
	      </p>
	      <p>Media: ${escape(media)}</p>
	    </li>`)}
	</ul>`;
});
...
const css$3 = {
	code: "ul.svelte-1uzksw3{margin:0 0 1em 0;line-height:1.5}",
	map: "{\"version\":3,\"file\":\"random.svelte\",\"sources\":[\"random.svelte\"],\"sourcesContent\":[\"<style>\\n  ul {\\n    margin: 0 0 1em 0;\\n    line-height: 1.5;\\n  }\\n</style>\\n\\n<h1>Random stuff</h1>\\n\\n<ul>\\n  <li>\\n    <a href=\\\"readings\\\">My 2019 readings</a>\\n  </li>\\n</ul>\\n\"],\"names\":[],\"mappings\":\"AACE,EAAE,eAAC,CAAC,AACF,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,CACjB,WAAW,CAAE,GAAG,AAClB,CAAC\"}"
};
...
const Footer = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<footer class="svelte-13x26vq">
	  <ul class="svelte-13x26vq">
	    ...
	    <li class="svelte-13x26vq">
	      <a rel=" noopener noreferrer" target="_blank" href="https://twitter.com/imalexlab" class="svelte-13x26vq">
